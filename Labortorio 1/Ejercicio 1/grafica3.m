%resolver el 1 bien inciso b)
% este es el que tiene el pivoteo y es casi una copia de grafica 1

function [a,s,t]=grafica3(n) %n es rango de matriz A
cont=zeros(1,n-3);
t1=zeros(1,n-3);
%t2=zeros(1,n-3);
